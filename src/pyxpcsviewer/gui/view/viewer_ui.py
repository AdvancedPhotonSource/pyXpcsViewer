...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        sizePolicy5.setHeightForWidth(self.pg_saxs.sizePolicy().hasHeightForWidth())
        self.pg_saxs.setSizePolicy(sizePolicy5)
        ...
        self.gridLayout_40.addWidget(self.cb_saxs2D_type, 1, 4, 1, 1)
        ...
        self.gridLayout_40.addWidget(self.saxs2d_max, 1, 10, 1, 1)
        ...
        self.gridLayout_40.addWidget(self.pushButton_plot_saxs2d, 1, 14, 1, 1)
        ...
        self.gridLayout_40.addWidget(self.saxs2d_min, 1, 9, 1, 1)
        ...
        self.gridLayout_40.addWidget(self.saxs2d_autolevel, 1, 12, 1, 1)
        ...
        self.gridLayout_40.addWidget(self.spinBox_saxs2d_selection, 0, 14, 1, 1)
        ...
        self.gridLayout_40.addWidget(self.horizontalSlider_saxs2d_selection, 0, 1, 1, 13)

        self.label_12 = QLabel(self.groupBox_3)
        self.label_12.setObjectName(u"label_12")

        self.gridLayout_40.addWidget(self.label_12, 1, 3, 1, 1)
        ...
        self.gridLayout_40.addWidget(self.saxs2d_rotate, 1, 13, 1, 1)
        ...
        self.gridLayout_40.addWidget(self.label_50, 1, 8, 1, 1)
        ...
        sizePolicy7.setHeightForWidth(self.mp_saxs.sizePolicy().hasHeightForWidth())
        self.mp_saxs.setSizePolicy(sizePolicy7)
        ...
        self.pushButton_plot_saxs1d = QPushButton(self.groupBox_13)
        ...
        sizePolicy8.setHeightForWidth(self.pushButton_plot_saxs1d.sizePolicy().hasHeightForWidth())
        self.pushButton_plot_saxs1d.setSizePolicy(sizePolicy8)

        self.gridLayout_32.addWidget(self.pushButton_plot_saxs1d, 0, 5, 1, 1)
        ...
        sizePolicy7.setHeightForWidth(self.pg_intt.sizePolicy().hasHeightForWidth())
        self.pg_intt.setSizePolicy(sizePolicy7)
        ...
        self.g2_scroll_area.setGeometry(QRect(0, 0, 1328, 539))
        ...
        sizePolicy6.setHeightForWidth(self.mp_g2.sizePolicy().hasHeightForWidth())
        self.mp_g2.setSizePolicy(sizePolicy6)
        ...
        sizePolicy10.setHeightForWidth(self.g2_qmin.sizePolicy().hasHeightForWidth())
        self.g2_qmin.setSizePolicy(sizePolicy10)
        ...
        sizePolicy10.setHeightForWidth(self.g2_qmax.sizePolicy().hasHeightForWidth())
        self.g2_qmax.setSizePolicy(sizePolicy10)
        ...
        sizePolicy10.setHeightForWidth(self.g2_ymin.sizePolicy().hasHeightForWidth())
        self.g2_ymin.setSizePolicy(sizePolicy10)
        ...
        sizePolicy10.setHeightForWidth(self.g2_ymax.sizePolicy().hasHeightForWidth())
        self.g2_ymax.setSizePolicy(sizePolicy10)
        ...
        sizePolicy10.setHeightForWidth(self.g2_tmin.sizePolicy().hasHeightForWidth())
        self.g2_tmin.setSizePolicy(sizePolicy10)
        ...
        sizePolicy10.setHeightForWidth(self.g2_tmax.sizePolicy().hasHeightForWidth())
        self.g2_tmax.setSizePolicy(sizePolicy10)
        ...
        sizePolicy10.setHeightForWidth(self.g2_yauto.sizePolicy().hasHeightForWidth())
        self.g2_yauto.setSizePolicy(sizePolicy10)
        ...
        sizePolicy10.setHeightForWidth(self.g2_sub_baseline.sizePolicy().hasHeightForWidth())
        self.g2_sub_baseline.setSizePolicy(sizePolicy10)
        ...
        sizePolicy10.setHeightForWidth(self.g2_show_fit.sizePolicy().hasHeightForWidth())
        self.g2_show_fit.setSizePolicy(sizePolicy10)
        ...
        sizePolicy10.setHeightForWidth(self.g2_show_label.sizePolicy().hasHeightForWidth())
        self.g2_show_label.setSizePolicy(sizePolicy10)
        ...
        sizePolicy10.setHeightForWidth(self.g2_plot_type.sizePolicy().hasHeightForWidth())
        self.g2_plot_type.setSizePolicy(sizePolicy10)
        ...
        sizePolicy12.setHeightForWidth(self.mp_2t.sizePolicy().hasHeightForWidth())
        self.mp_2t.setSizePolicy(sizePolicy12)
        ...
        sizePolicy10.setHeightForWidth(self.cb_twotime_cmap.sizePolicy().hasHeightForWidth())
        self.cb_twotime_cmap.setSizePolicy(sizePolicy10)
        ...
        sizePolicy13.setHeightForWidth(self.pg_qmap.sizePolicy().hasHeightForWidth())
        self.pg_qmap.setSizePolicy(sizePolicy13)

        self.gridLayout_9.addWidget(self.pg_qmap, 0, 0, 1, 2)

        self.groupBox_22 = QGroupBox(self.tab)
        ...
        self.gridLayout_46.addWidget(self.label_27, 0, 0, 1, 1)

        self.comboBox_qmap_target = QComboBox(self.groupBox_22)
        self.comboBox_qmap_target.addItem("")
        self.comboBox_qmap_target.addItem("")
        self.comboBox_qmap_target.addItem("")
        self.comboBox_qmap_target.setObjectName(u"comboBox_qmap_target")

        self.gridLayout_46.addWidget(self.comboBox_qmap_target, 0, 1, 1, 1)

        self.label_71 = QLabel(self.groupBox_22)
        self.label_71.setObjectName(u"label_71")

        self.gridLayout_46.addWidget(self.label_71, 0, 2, 1, 1)

        self.cb_qmap_cmap = QComboBox(self.groupBox_22)
        ...
        self.cb_qmap_cmap.addItem("")
        self.cb_qmap_cmap.addItem("")
        self.cb_qmap_cmap.setObjectName(u"cb_qmap_cmap")

        self.gridLayout_46.addWidget(self.cb_qmap_cmap, 0, 3, 1, 1)


        self.gridLayout_9.addWidget(self.groupBox_22, 1, 0, 1, 2)
        ...
        sizePolicy14.setHeightForWidth(self.groupBox_8.sizePolicy().hasHeightForWidth())
        self.groupBox_8.setSizePolicy(sizePolicy14)
        ...
        sizePolicy15.setHeightForWidth(self.btn_submit_job.sizePolicy().hasHeightForWidth())
        self.btn_submit_job.setSizePolicy(sizePolicy15)
        ...
        self.groupBox_18 = QGroupBox(self.splitter_5)
        self.groupBox_18.setObjectName(u"groupBox_18")
        self.gridLayout_23 = QGridLayout(self.groupBox_18)
        ...
        sizePolicy13.setHeightForWidth(self.widget_g2map_all.sizePolicy().hasHeightForWidth())
        self.widget_g2map_all.setSizePolicy(sizePolicy13)

        self.gridLayout_23.addWidget(self.widget_g2map_all, 0, 0, 1, 1)

        self.splitter_5.addWidget(self.groupBox_18)
        self.groupBox_19 = QGroupBox(self.splitter_5)
        self.groupBox_19.setObjectName(u"groupBox_19")
        self.gridLayout_37 = QGridLayout(self.groupBox_19)
        ...
        sizePolicy13.setHeightForWidth(self.widget_g2map_qmap.sizePolicy().hasHeightForWidth())
        self.widget_g2map_qmap.setSizePolicy(sizePolicy13)

        self.gridLayout_37.addWidget(self.widget_g2map_qmap, 0, 0, 1, 1)

        self.splitter_5.addWidget(self.groupBox_19)
        self.splitter_6.addWidget(self.splitter_5)
        self.groupBox_20 = QGroupBox(self.splitter_6)
        self.groupBox_20.setObjectName(u"groupBox_20")
        self.gridLayout_41 = QGridLayout(self.groupBox_20)
        ...
        sizePolicy13.setHeightForWidth(self.widget_g2map_profile.sizePolicy().hasHeightForWidth())
        self.widget_g2map_profile.setSizePolicy(sizePolicy13)

        self.gridLayout_41.addWidget(self.widget_g2map_profile, 0, 0, 1, 1)

        self.splitter_6.addWidget(self.groupBox_20)

        self.gridLayout_42.addWidget(self.splitter_6, 0, 0, 1, 2)

        self.groupBox_17 = QGroupBox(self.tab_10)
        self.groupBox_17.setObjectName(u"groupBox_17")
        self.gridLayout_20 = QGridLayout(self.groupBox_17)
        ...
        self.spinBox_qbin = QSpinBox(self.groupBox_17)
        self.spinBox_qbin.setObjectName(u"spinBox_qbin")
        ...
        sizePolicy9.setHeightForWidth(self.scrollArea_2.sizePolicy().hasHeightForWidth())
        self.scrollArea_2.setSizePolicy(sizePolicy9)
        ...
        self.g2_scroll_area_2.setGeometry(QRect(0, 0, 1328, 540))
        ...
        sizePolicy6.setHeightForWidth(self.mp_g2_stability.sizePolicy().hasHeightForWidth())
        self.mp_g2_stability.setSizePolicy(sizePolicy6)
        ...
        sizePolicy10.setHeightForWidth(self.g2_qmin_2.sizePolicy().hasHeightForWidth())
        self.g2_qmin_2.setSizePolicy(sizePolicy10)
        ...
        sizePolicy10.setHeightForWidth(self.g2_qmax_2.sizePolicy().hasHeightForWidth())
        self.g2_qmax_2.setSizePolicy(sizePolicy10)
        ...
        sizePolicy10.setHeightForWidth(self.g2_ymin_2.sizePolicy().hasHeightForWidth())
        self.g2_ymin_2.setSizePolicy(sizePolicy10)
        ...
        sizePolicy10.setHeightForWidth(self.g2_ymax_2.sizePolicy().hasHeightForWidth())
        self.g2_ymax_2.setSizePolicy(sizePolicy10)
        ...
        sizePolicy10.setHeightForWidth(self.g2_tmin_2.sizePolicy().hasHeightForWidth())
        self.g2_tmin_2.setSizePolicy(sizePolicy10)
        ...
        sizePolicy10.setHeightForWidth(self.g2_tmax_2.sizePolicy().hasHeightForWidth())
        self.g2_tmax_2.setSizePolicy(sizePolicy10)
        ...
        sizePolicy10.setHeightForWidth(self.g2_yauto_2.sizePolicy().hasHeightForWidth())
        self.g2_yauto_2.setSizePolicy(sizePolicy10)
        ...
        sizePolicy10.setHeightForWidth(self.g2_show_label_2.sizePolicy().hasHeightForWidth())
        self.g2_show_label_2.setSizePolicy(sizePolicy10)
        ...
        sizePolicy10.setHeightForWidth(self.g2_sub_baseline_2.sizePolicy().hasHeightForWidth())
        self.g2_sub_baseline_2.setSizePolicy(sizePolicy10)
        ...
        sizePolicy10.setHeightForWidth(self.g2_plot_type_2.sizePolicy().hasHeightForWidth())
        self.g2_plot_type_2.setSizePolicy(sizePolicy10)
        ...
        self.gridLayout_53 = QGridLayout(self.tab_12)
        self.gridLayout_53.setObjectName(u"gridLayout_53")
        self.splitter_8 = QSplitter(self.tab_12)
        self.splitter_8.setObjectName(u"splitter_8")
        self.splitter_8.setOrientation(Qt.Orientation.Horizontal)
        self.groupBox_9 = QGroupBox(self.splitter_8)
        self.groupBox_9.setObjectName(u"groupBox_9")
        sizePolicy16.setHeightForWidth(self.groupBox_9.sizePolicy().hasHeightForWidth())
        self.groupBox_9.setSizePolicy(sizePolicy16)
        ...
        sizePolicy17.setHeightForWidth(self.horizontalSlider_G2_delay.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy11.setHeightForWidth(self.groupBox_12.sizePolicy().hasHeightForWidth())
        self.groupBox_12.setSizePolicy(sizePolicy11)
        ...
        self.pg_regroup_g2.setObjectName(u"pg_regroup_g2")
        sizePolicy11.setHeightForWidth(self.pg_regroup_g2.sizePolicy().hasHeightForWidth())
        self.pg_regroup_g2.setSizePolicy(sizePolicy11)
        ...
        sizePolicy19.setHeightForWidth(self.label_G2_external_qmapfname.sizePolicy().hasHeightForWidth())
        self.label_G2_external_qmapfname.setSizePolicy(sizePolicy19)
        ...
        self.label_78 = QLabel(self.tab_15)
        self.label_78.setObjectName(u"label_78")

        self.gridLayout_52.addWidget(self.label_78, 0, 0, 1, 2)

        self.label_79 = QLabel(self.tab_15)
        self.label_79.setObjectName(u"label_79")

        self.gridLayout_52.addWidget(self.label_79, 1, 0, 1, 1)

        self.spinBox_G2_num_sbin = QSpinBox(self.tab_15)
        self.spinBox_G2_num_sbin.setObjectName(u"spinBox_G2_num_sbin")
        ...
        sizePolicy20.setHeightForWidth(self.groupBox_23.sizePolicy().hasHeightForWidth())
        self.groupBox_23.setSizePolicy(sizePolicy20)
        ...
        self.comboBox_G2_outliermethod.addItem("")
        self.comboBox_G2_outliermethod.setObjectName(u"comboBox_G2_outliermethod")
        ...
        self.gridLayout_50.addWidget(self.label_76, 0, 2, 1, 1)

        self.doubleSpinBox_G2_threshold = QDoubleSpinBox(self.groupBox_23)
        self.doubleSpinBox_G2_threshold.setObjectName(u"doubleSpinBox_G2_threshold")
        self.doubleSpinBox_G2_threshold.setValue(3.000000000000000)
    ...
    def retranslateUi(self, mainWindow):
        ...
        self.groupBox_22.setTitle(QCoreApplication.translate("mainWindow", u"Settings", None))
        ...
        self.label_71.setText(QCoreApplication.translate("mainWindow", u"Cmap", None))
        self.cb_qmap_cmap.setItemText(0, QCoreApplication.translate("mainWindow", u"tab20b", None))
        self.cb_qmap_cmap.setItemText(1, QCoreApplication.translate("mainWindow", u"jet", None))
        self.cb_qmap_cmap.setItemText(2, QCoreApplication.translate("mainWindow", u"hot", None))
        self.cb_qmap_cmap.setItemText(3, QCoreApplication.translate("mainWindow", u"plasma", None))
        self.cb_qmap_cmap.setItemText(4, QCoreApplication.translate("mainWindow", u"viridis", None))
        self.cb_qmap_cmap.setItemText(5, QCoreApplication.translate("mainWindow", u"magma", None))
        ...
        self.groupBox_19.setTitle(QCoreApplication.translate("mainWindow", u"qmap", None))
        self.groupBox_20.setTitle(QCoreApplication.translate("mainWindow", u"g2 profile", None))
