...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.cb_saxs_type.setItemText(0, _translate("Form", "I - q"))
        self.cb_saxs_type.setItemText(1, _translate("Form", "I - log(q)"))
        self.cb_saxs_type.setItemText(2, _translate("Form", "log(I) - q"))
        self.cb_saxs_type.setItemText(3, _translate("Form", "log(I) - log(q)"))
        self.label_22.setText(_translate("Form", "offset:"))
        self.label_23.setText(_translate("Form", "normalization:"))
        self.cb_saxs_norm.setItemText(0, _translate("Form", "none"))
        self.cb_saxs_norm.setItemText(1, _translate("Form", "I\' = Iq2"))
        self.cb_saxs_norm.setItemText(2, _translate("Form", "I\' = Iq4"))
        self.cb_saxs_norm.setItemText(3, _translate("Form", "I\' = I/Io"))
